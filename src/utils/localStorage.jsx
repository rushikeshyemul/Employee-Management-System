    ...
    tasks: [
      {
        ...
        taskDescription: "Implement new security measures for data protection.",
        taskDate: "2024-12-02",
        category: "Security",
      },
      {
    ...
    tasks: [
      {
        ...
        taskDescription: "Explore emerging technologies for future projects.",
        taskDate: "2024-12-05",
        category: "Research",
      },
      {
        ...
        completed: false,
        failed: false,
        taskTitle: "Collaborate with design team",
        taskDescription: "Work with designers on UI improvements.",
        taskDate: "2024-12-03",
      ...
      },
      {
        ...
        taskDescription: "Resolve the critical bug in the payment system.",
        taskDate: "2024-11-29",
        category: "Bug Fixing",
      },
    ],
